                ...
                <header id="fh5co-header-section">
                    <div class="container h-100">
                        <div class="nav-header h-100">
                            ...
                            <div id="fh5co-logo"><a href="{{route('iosclub.home')}}"><span>IOS Club</span></a></div>
                            <!-- START #fh5co-menu-wrap -->
                            <nav id="fh5co-menu-wrap" role="navigation">
                                <ul class="sf-menu" id="fh5co-primary-menu">
                                    <li>
                                        <a href="{{route('rtc.home')}}">RTC</a>
                                    </li>
                                    <li class="active">
                                        <a href="{{route('iosclub.home')}}">Home</a>
                                    </li>
                                    <li>
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-md-6 col-md-offset-3 text-center">
                                ...
                                <p>Copyright 2016 Free Html5 <a href="#">Guardian</a>. All Rights Reserved.
                                    <br>Made with <i class="icon-heart3"></i> by <a href="http://freehtml5.co/" target="_blank">Freehtml5.co</a> / Demo Images: <a href="https://unsplash.com/" target="_blank">Unsplash</a></p>
                            </div>
                        </div>
                    </div>
                </div>
